  ...
  useEffect(() => {
    const fetchDetail = async () => {
      try {
        ...
        setProduct(data);
        setPreview(`${API_URL}/uploads/ProductImage/${data.Image}`);
      } catch {
      ...
      <div className="max-w-6xl mx-auto mt-6 flex gap-6">
        ...
        <div className="flex-1 bg-white p-8 rounded-xl shadow-sm relative">
          <button
            ...
            className="absolute top-4 left-4 text-sm text-orange-500 hover:underline"
          >
            ← Trở về
          </button>
          ...
          <div className="space-y-5 max-w-xl mx-auto">
            ...
            <div className="flex justify-center pt-4">
              <button
                onClick={handleSave}
                className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-2 rounded-lg font-semibold shadow"
              >
                Lưu thay đổi
              </button>
            </div>
